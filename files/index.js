...
$(document).ready(function () {
  ...
  $('.zoom-two-container').each(function() {
    const containerElement = $(this);
    zoomWidget = new ZoomWidgetTwo(containerElement);
  });
...
class ZoomWidget {
  constructor(container) {
    ...
    this.context2 = this.canvas[1].getContext("2d");
    this.image = new Image();
    this.image.src = this.container.data('gt-img-src');
    this.image2 = new Image();
    this.image2.src = this.container.data('gt-img-src2');
  ...
  handleZoom(x = null, y = null, u = null, v = null) {
    ...
    this.context2.clearRect(0, 0, this.canvas[0].width, this.canvas[0].height);
    ...
    this.canvas[1].width = imageWidth;
    this.canvas[1].height = imageHeight;
    this.context2.drawImage(this.image2, 0, 0, imageWidth, imageHeight);
    ...
    this.context2.strokeStyle = '#DB4437';
    this.context2.lineWidth = 2;
    this.context2.strokeRect(
      x - zoomCursorWidth / 2, y - zoomCursorHeight / 2, zoomCursorWidth, zoomCursorHeight);
  }
}
